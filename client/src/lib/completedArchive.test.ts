...
describe("墨痕錦匣年月分組", () => {
  it("會依完稿日期由新至舊分成年度與月份", () => {
    const items = [
      { id: "old", updatedAt: 1704067200000, completedAt: 1704067200000 },
      { id: "summer", updatedAt: 1754006400000, completedAt: 1754006400000 },
      { id: "late", updatedAt: 1756684800000, completedAt: 1756684800000 },
    ] as never[];
