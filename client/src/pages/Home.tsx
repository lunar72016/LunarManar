...
function CommissionWorkspace() {
  ...
  const discardSubmission = async (submission: import("@/lib/clientPortal").ClientSubmission) => {
    ...
    try {
      await intake.discardSubmission(submission.id);
      toast.success("已刪除未受理委託函");
    } catch (discardError) {
