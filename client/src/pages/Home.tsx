...
function CommissionWorkspace() {
  ...
  const heading = activeView === "dashboard" ? "運筆宮商" : activeView === "board" ? "排畫連雲" : activeView === "archive" ? "封畫入卷" : "丹青設案";
  ...
  return <TooltipProvider><Toaster richColors position="top-right" /><DashboardLayout activeView={activeView} onViewChange={setActiveView} syncState={syncState} studioName={studio.settings.studioName}>
    ...
    <CommissionViewDialog commission={selected} open={viewOpen} onOpenChange={setViewOpen} onEdit={openEdit} onArchive={archive} onRestore={restore} onDelete={removeCommission} />
